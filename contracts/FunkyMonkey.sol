...
// @author Lokesh Dulani
// @contact lokeshdulani91@gmail.com

contract FunkyMonkey is 
    ERC721, 
    Ownable, 
    ReentrancyGuard, 
    PaymentSplitter 
{
    ...
    string public notRevealedUri = "ipfs://QmUv4nhzZQSVt2gca9Ry7VbF7eyY1qbGxHjDHfXreZvgzE/hidden.json";
    ...
    uint256 _price = 10000000000000000; // 0.01 ETH = 10^16 wei

    Counters.Counter private _tokenIds;

    uint256[] private _teamShares = [25, 35, 40]; // 3 PEOPLE IN THE TEAM
    address[] private _team = [
        0x24CC25fD703C03608489dFc1D974CCb9EB5BA6a5, // Admin Account gets 25% of the total revenue
        0x79F8aC02AfD83E41004bC43EED741197dc66A205, // Test Account gets 35% of the total revenue
        0x52031Fc6D01977D526c06a463640F44CfA0dAFD1 // VIP Account gets 40% of the total revenue
    ];

    constructor(string memory uri, bytes32 merkleroot, address _proxyRegistryAddress)
        ERC721("FunkyMonkey", "Monkey")
