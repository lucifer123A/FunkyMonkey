        ...
        <div className='flex items-center container mx-auto max-w-5xl justify-between h-full'>
          <Link href="#">
            <a className='font-coiny text-xl md:text-xl font-bold'>
              <span className='bg-gradient-to-br from-brand-blue to-brand-purple pr-2 bg-clip-text text-transparent'>Funky</span>
              Monkey
            </a>
          </Link>
           ...
           <nav aria-label="Contact Menu">
            <ul className="flex items-center space-x-4 md:space-x-6">
              ...
              <li className="cursor-pointer">
                <a
                  href="https://twitter.com/DulaniLokesh"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
              ...
              <li className="cursor-pointer">
                <a
                  href="https://discord.com/channels/979756357794275328/979756357794275331"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
        ...
        <div className="flex flex-col md:flex-row md:space-x-16 space-y-10 items-center mt-20 w-full">
            ...
            <div className="flex flex-col md:items-start items-center justify-center text-center font-coiny text-gray-800 px-4 md:px-0 py-10 mt-14">
              ...
              <p className="mt-6 text-lg">
                {`FunkyMonkey are a collection of 5,555 burning hot NFTs living in
                the core of the blockchain. Each individual FunkyMonkey is
                carefully curated from over 150 traits, along with some
                incredibly rare 1/1s that have traits that can't be found from
                any other FunkyMonkey. Our vision is to create an amazing project
